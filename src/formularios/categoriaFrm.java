...
public class categoriaFrm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        catSpiner.addChangeListener(new javax.swing.event.ChangeListener() {
            public void stateChanged(javax.swing.event.ChangeEvent evt) {
                catSpinerStateChanged(evt);
            }
        });
        catSpiner.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                catSpinerKeyTyped(evt);
            }
        });
    ...
    private void catSpinerStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_catSpinerStateChanged
        int cant = (int)catSpiner.getValue();
        if(cant<=0 || cant > 100){
            JOptionPane.showMessageDialog(null, "No puede ser una cantidad menor a 0 o superior a 100");
            catSpiner.setValue(0);
        }
    }//GEN-LAST:event_catSpinerStateChanged

    private void catSpinerKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_catSpinerKeyTyped
        // TODO add your handling code here:
    }//GEN-LAST:event_catSpinerKeyTyped
